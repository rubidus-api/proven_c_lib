...
그 밖의 모든 것은 [호출자 소유 상태](manual-ko.md#42-caller-owned-state-no-destroy-do-not-copy)다—
...
셋 모두 [호출자 소유 상태](manual-ko.md#42-caller-owned-state-no-destroy-do-not-copy)다.
...
셋 모두 [호출자 소유 상태](manual-ko.md#42-caller-owned-state-no-destroy-do-not-copy)다: 아무것도
