...
int main(void) {
    PROVEN_TEST_SUITE(
        "test_portability_nob_std_probe",
    ...
    const char *wrapper_path = "tests/test_portability_nob_std_probe.fakecc";
    const char *log_path = "tests/test_portability_nob_std_probe.log";
    ...
    int rc = run_cmd("./nob regression -build-root build/test_portability_nob_std_probe -cc ./tests/test_portability_nob_std_probe.fakecc");
