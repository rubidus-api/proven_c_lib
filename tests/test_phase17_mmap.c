...
int main() {
    ...
    proven_result_file_t file_res = proven_fs_open(path, PROVEN_FS_WRITE | PROVEN_FS_READ | PROVEN_FS_CREATE | PROVEN_FS_TRUNC);
    ...
    file_res = proven_fs_open(path, PROVEN_FS_READ);
    char buf[64] = {0};
