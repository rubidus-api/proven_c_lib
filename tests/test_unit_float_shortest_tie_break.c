...
int main(void) {
    PROVEN_TEST_SUITE(
        "test_unit_float_shortest_tie_break",
        ...
        "Inspect tests/test_unit_float_shortest_roundtrip.c and tests/test_differential_float_corpus_f64.c if the fixed-versus-scientific tie-break coverage disappears."
    );

    char *roundtrip = read_file_text("tests/test_unit_float_shortest_roundtrip.c");
    char *corpus = read_file_text("tests/test_differential_float_corpus_f64.c");
