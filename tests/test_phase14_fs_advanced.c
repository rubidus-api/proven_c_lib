...
int main() {
    ...
    proven_u8str_view_t dir_name = PROVEN_LIT("test_phase14_dir");
    proven_u8str_view_t file_a = PROVEN_LIT("test_phase14_dir/file_a.txt");
    proven_u8str_view_t file_b = PROVEN_LIT("test_phase14_dir/file_b.txt");
    proven_u8str_view_t file_c = PROVEN_LIT("test_phase14_dir/file_c.txt");
